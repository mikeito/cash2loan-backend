...
public class Cash2loanApplication {
	...
	CommandLineRunner run(AppUserService appUserService) {
		return args -> {
			...
			// save users
			appUserService.saveUser(new AppUser(null, "John smith", "john@gmail.com", "1234", new ArrayList<>()));
			appUserService.saveUser(new AppUser(null, "Admin user", "admin@gmail.com", "admin", new ArrayList<>()));
